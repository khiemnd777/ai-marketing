...
- AES-256-GCM Meta tokens with random nonces and scope-bound associated data; one-time hashed OAuth state; server-only provider secrets; safe provider configuration responses; no browser-to-provider calls.
